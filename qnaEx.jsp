...
<div id="wrap">
 ...
 <% 
  ...
  <div id ="page_main">
 <%
	 String uploadPath = "C:\\wep\\teampro\\WebContent\\teampro2\\qna";
	int maxSize = 1024 * 1024 * 100; // 한번에 올릴 수 있는 파일 용량 : 100M로 제한
	MultipartRequest multi = null;
	 multi = new MultipartRequest(request,uploadPath,maxSize,"utf-8",new DefaultFileRenamePolicy());     
    String userId = Id;
    String qnaKind = multi.getParameter("qnaKind");
	 String qnaTitle = multi.getParameter("qnaTitle");
    String qnaMain = multi.getParameter("qnaMain");
    String qnaImage = multi.getOriginalFileName("qnaImage"); 
%>
<% 
  if (qnaTitle.equals("")==true) {
      %>
   ...
   <%
	  ...
	  Qna qna = new Qna(userId,qnaKind,qnaTitle,qnaMain,qnaImage,new java.util.Date());
