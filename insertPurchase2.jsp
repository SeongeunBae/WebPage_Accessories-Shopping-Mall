...
<div id="wrap">
 ...
 <% 
  ...
  <%  
    ...
    int phoneNum2 = Integer.parseInt(request.getParameter("phoneNum2"));
    int phoneNum3 = Integer.parseInt(request.getParameter("phoneNum3"));
	...
	String optionSum = request.getParameter("optionSum"+i);
	int count = Integer.parseInt(request.getParameter("count"+i));
	int price = Integer.parseInt(request.getParameter("price"+i));
	int payment = count * price;
	 Purchase purchase = new Purchase(userId,productName,optionSum,count,payment,recipient,sample6_postcode,sample6_address,daddress,phoneNumber,memo,payMethod,new java.util.Date());
...
%>
<div id = "title">상품을 구매 해주셔서 감사합니다. 
<br>구매상품에 대한 정보는 마이페이지에서! </br></div>
  </div>
  <div id="page_footer"> 
