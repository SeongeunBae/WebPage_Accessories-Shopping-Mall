     ...
     <table width="1000" border="1" cellspacing="0" cellpadding="10">
      <tr>
        ...
        <td width="800"><label for="qnaTitle"></label>
         <input name="qnaTitle" type="text" id="qnaTitle" size="70" value="${qna.qnaTitle}" disabled  />
         </td>
      </tr>
      <tr>
      <th>내용</th>
      <td>
          <textarea name="qnaMain" id="qnaMain" cols="120" rows="20 " disabled/>${qna.qnaMain}</textarea>
      </td>
      </table> 
    </form>
   </div>
