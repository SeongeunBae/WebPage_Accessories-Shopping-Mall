    ...
    <script>
      ...
      function searchForm(frm){
          if (frm.searchbox.value == "") {
             alert("검색 단어를 입력하세여.");
             frm.searchbox.focus();  //keyword 입력부분에 커서위치
             return ;
          }
          frm.submit();  // form문에 submit 버튼 누름과 같음
       }
      </script>
</head>
<body>
<div id="wrap">
 ...
 <% 
  ...
  <div id="mainimage">
  <img src="images/main1.png" name="main" width="1400" height="480" id="main" /></a></div>
<div id="page_main">
   <% 
       		...
       		try {
       			...
       			productList = dao.selectListCondition(conn, "registerTime", "desc");
