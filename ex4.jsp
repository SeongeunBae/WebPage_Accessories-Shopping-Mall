...
<div id="wrap">
 ...
 <% 
  ...
  <div id ="page_main">
<%String pdkind= request.getParameter("pdkind"); %>
<div id="title"><%=pdkind %></div>
 ...
 <%
        	...
        	try{
        		...
        		productList3 = dao.selectList3(conn,pdkind);
        ...
        %>
         ...
         <c:forEach var = "product" items = "<%=productList3%>">
                 ...
                 <img src="itemimage/${product.smallImage}"/></a><p align ="center">
                 ${product.price}원</p>
                  </a>
                  </div>
        </c:forEach>
